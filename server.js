...
const getcurrentstudentpass = require('./routes/student/changepass/getcurrentstudentpass');
...
app.use('/api/student-password', getcurrentstudentpass(db));
app.use('/api/update-student-password',updatestudentpassword(db));
